...
const StakingCart = () => {
  return (
    <div className="flex flex-col rounded-lg w-[250px] h-[300px] bg-orange-200 p-4">
      <p className="text-lg bold font-extrabold">WD-Staking Pool v.1</p>
      <div className="py-2">
